...
class RekordboxPdb(KaitaiStruct):
    ...
    def __init__(self, is_ext, _io, _parent=None, _root=None):
        super(RekordboxPdb, self).__init__(_io)
    ...
    def _read(self):
        ...
        if not self.gap == b"\x00\x00\x00\x00":
            raise kaitaistruct.ValidationNotEqualError(b"\x00\x00\x00\x00", self.gap, self._io, u"/seq/6")
        self.tables = []
    ...
    class AlbumRow(KaitaiStruct):
        ...
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.AlbumRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def name(self):
            ...
            _pos = self._io.pos()
            self._io.seek(self._parent.row_base + (self.ofs_name_far if self.subtype & 4 == 4 else self.ofs_name_near))
        ...
        def ofs_name_far(self):
            ...
            if self.subtype & 4 == 4:
                pass
                _pos = self._io.pos()
                self._io.seek(self._parent.row_base + 22)
    ...
    class ArtistRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.ArtistRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class ArtworkRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.ArtworkRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class ColorRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.ColorRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class DeviceSqlLongAscii(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.DeviceSqlLongAscii, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.text = (self._io.read_bytes(self.length - 4)).decode(u"ASCII")
    ...
    class DeviceSqlLongUtf16le(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.DeviceSqlLongUtf16le, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            self.length = self._io.read_u2le()
            self._unnamed1 = self._io.read_u1()
            self.text = (self._io.read_bytes(self.length - 4)).decode(u"UTF-16LE")
    ...
    class DeviceSqlShortAscii(KaitaiStruct):
        ...
        def __init__(self, length_and_kind, _io, _parent=None, _root=None):
            super(RekordboxPdb.DeviceSqlShortAscii, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _read(self):
            self.text = (self._io.read_bytes(self.length - 1)).decode(u"ASCII")
    ...
    class DeviceSqlString(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.DeviceSqlString, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            if _on == 144:
                pass
                self.body = RekordboxPdb.DeviceSqlLongUtf16le(self._io, self, self._root)
            elif _on == 64:
                pass
                self.body = RekordboxPdb.DeviceSqlLongAscii(self._io, self, self._root)
            else:
                pass
                self.body = RekordboxPdb.DeviceSqlShortAscii(self.length_and_kind, self._io, self, self._root)
    ...
    class GenreRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.GenreRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class HistoryEntryRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.HistoryEntryRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class HistoryPlaylistRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.HistoryPlaylistRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class KeyRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.KeyRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class LabelRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.LabelRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class Page(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.Page, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            self.gap = self._io.read_bytes(4)
            if not self.gap == b"\x00\x00\x00\x00":
                raise kaitaistruct.ValidationNotEqualError(b"\x00\x00\x00\x00", self.gap, self._io, u"/types/page/seq/0")
            self.page_index = self._io.read_u4le()
            if (not (self._root.is_ext)):
                pass
                self.type = KaitaiStream.resolve_enum(RekordboxPdb.PageType, self._io.read_u4le())

            if self._root.is_ext:
                pass
                self.type_ext = KaitaiStream.resolve_enum(RekordboxPdb.PageTypeExt, self._io.read_u4le())

            self.next_page = RekordboxPdb.PageRef(self._io, self, self._root)
            self.sequence = self._io.read_u4le()
            self._unnamed6 = self._io.read_bytes(4)
            self.num_row_offsets = self._io.read_bits_int_le(13)
            self.num_rows = self._io.read_bits_int_le(11)
            self.page_flags = self._io.read_u1()
            self.free_size = self._io.read_u2le()
            self.used_size = self._io.read_u2le()
            self.transaction_row_count = self._io.read_u2le()
            self.transaction_row_index = self._io.read_u2le()
        ...
        def _fetch_instances(self):
            ...
            if hasattr(self, '_m_row_groups'):
                pass
                for i in range(len(self._m_row_groups)):
                    pass
                    self._m_row_groups[i]._fetch_instances()
        ...
        def num_row_groups(self):
            ...
            self._m_num_row_groups = (self.num_row_offsets - 1) // 16 + 1
        ...
        def row_groups(self):
            ...
            if self.is_data_page:
                ...
                for i in range(self.num_row_groups):
                    self._m_row_groups.append(RekordboxPdb.RowGroup(i, self._io, self, self._root))
    ...
    class PageRef(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.PageRef, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class PlaylistEntryRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.PlaylistEntryRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class PlaylistTreeRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.PlaylistTreeRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class RowGroup(KaitaiStruct):
        ...
        def __init__(self, group_index, _io, _parent=None, _root=None):
            super(RekordboxPdb.RowGroup, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _fetch_instances(self):
            ...
            if hasattr(self, '_m_rows'):
                pass
                for i in range(len(self._m_rows)):
                    pass
                    self._m_rows[i]._fetch_instances()


            _ = self.transaction_row_flags
            if hasattr(self, '_m_transaction_row_flags'):
                pass
        ...
        @property
        def transaction_row_flags(self):
            ...
            """
            if hasattr(self, '_m_transaction_row_flags'):
                return self._m_transaction_row_flags

            _pos = self._io.pos()
            self._io.seek(self.base)
            self._m_transaction_row_flags = self._io.read_u2le()
            self._io.seek(_pos)
            return getattr(self, '_m_transaction_row_flags', None)
    ...
    class RowRef(KaitaiStruct):
        ...
        def __init__(self, row_index, _io, _parent=None, _root=None):
            super(RekordboxPdb.RowRef, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _fetch_instances(self):
            ...
            if hasattr(self, '_m_body'):
                ...
                if _on == RekordboxPdb.PageType.albums:
                    pass
                    self._m_body._fetch_instances()
                    ...
                    pass
                    self._m_body._fetch_instances()
                elif _on == RekordboxPdb.PageType.playlist_tree:
                    pass
                    self._m_body._fetch_instances()
            ...
            if hasattr(self, '_m_body_ext'):
                ...
                if _on == RekordboxPdb.PageTypeExt.tag_tracks:
                    pass
                    self._m_body_ext._fetch_instances()
                elif _on == RekordboxPdb.PageTypeExt.tags:
                    pass
                    self._m_body_ext._fetch_instances()
        ...
        def body(self):
            ...
            if  ((self.present) and ((not (self._root.is_ext)))) :
                ...
                if _on == RekordboxPdb.PageType.albums:
                    ...
                    pass
                    self._m_body = RekordboxPdb.HistoryEntryRow(self._io, self, self._root)
                elif _on == RekordboxPdb.PageType.history_playlists:
                    pass
                    self._m_body = RekordboxPdb.HistoryPlaylistRow(self._io, self, self._root)
                elif _on == RekordboxPdb.PageType.keys:
                    pass
                    ...
                    pass
                    self._m_body = RekordboxPdb.PlaylistEntryRow(self._io, self, self._root)
                elif _on == RekordboxPdb.PageType.playlist_tree:
                    pass
                    self._m_body = RekordboxPdb.PlaylistTreeRow(self._io, self, self._root)
                elif _on == RekordboxPdb.PageType.tracks:
                    pass
        ...
        def body_ext(self):
            ...
            if  ((self.present) and (self._root.is_ext)) :
                ...
                if _on == RekordboxPdb.PageTypeExt.tag_tracks:
                    pass
                    self._m_body_ext = RekordboxPdb.TagTrackRow(self._io, self, self._root)
                elif _on == RekordboxPdb.PageTypeExt.tags:
                    pass
        ...
        def present(self):
            ...
            self._m_present = (True if self._parent.row_present_flags >> self.row_index & 1 != 0 else False)
    ...
    class Table(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.Table, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _fetch_instances(self):
            ...
            self.first_page._fetch_instances()
            self.last_page._fetch_instances()
    ...
    class TagRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.TagRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self._unnamed7 = self._io.read_u1()
            self.ofs_name_near = self._io.read_u1()
            self.ofs_unknown_near = self._io.read_u1()
        ...
        def ofs_name_far(self):
            ...
            if self.subtype & 4 == 4:
                pass
                _pos = self._io.pos()
                self._io.seek(self._parent.row_base + 30)
                self._m_ofs_name_far = self._io.read_u2le()
                self._io.seek(_pos)
    ...
    class TagTrackRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.TagTrackRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class TrackRow(KaitaiStruct):
        ...
        """
        def __init__(self, _io, _parent=None, _root=None):
            super(RekordboxPdb.TrackRow, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _fetch_instances(self):
            pass
            for i in range(len(self.ofs_strings)):
                pass

            _ = self.analyze_date
            if hasattr(self, '_m_analyze_date'):
                pass
                self._m_analyze_date._fetch_instances()

            _ = self.analyze_path
            if hasattr(self, '_m_analyze_path'):
                pass
                self._m_analyze_path._fetch_instances()

            _ = self.autoload_hot_cues
            if hasattr(self, '_m_autoload_hot_cues'):
                pass
                self._m_autoload_hot_cues._fetch_instances()

            _ = self.comment
            if hasattr(self, '_m_comment'):
                pass
                self._m_comment._fetch_instances()

            _ = self.date_added
            if hasattr(self, '_m_date_added'):
                pass
                self._m_date_added._fetch_instances()

            _ = self.file_path
            if hasattr(self, '_m_file_path'):
                pass
                self._m_file_path._fetch_instances()

            _ = self.filename
            if hasattr(self, '_m_filename'):
                pass
                self._m_filename._fetch_instances()

            _ = self.isrc
            if hasattr(self, '_m_isrc'):
                pass
                self._m_isrc._fetch_instances()

            _ = self.kuvo_public
            if hasattr(self, '_m_kuvo_public'):
                pass
                self._m_kuvo_public._fetch_instances()

            _ = self.message
            if hasattr(self, '_m_message'):
                pass
                self._m_message._fetch_instances()

            _ = self.mix_name
            if hasattr(self, '_m_mix_name'):
                pass
                self._m_mix_name._fetch_instances()

            _ = self.release_date
            if hasattr(self, '_m_release_date'):
                pass
                self._m_release_date._fetch_instances()

            _ = self.texter
            if hasattr(self, '_m_texter'):
                pass
                self._m_texter._fetch_instances()

            _ = self.title
            if hasattr(self, '_m_title'):
                pass
                self._m_title._fetch_instances()

            _ = self.unknown_string_2
            if hasattr(self, '_m_unknown_string_2'):
                pass
                self._m_unknown_string_2._fetch_instances()

            _ = self.unknown_string_3
            if hasattr(self, '_m_unknown_string_3'):
                pass
                self._m_unknown_string_3._fetch_instances()

            _ = self.unknown_string_4
            if hasattr(self, '_m_unknown_string_4'):
                pass
                self._m_unknown_string_4._fetch_instances()

            _ = self.unknown_string_5
            if hasattr(self, '_m_unknown_string_5'):
                pass
                self._m_unknown_string_5._fetch_instances()

            _ = self.unknown_string_6
            if hasattr(self, '_m_unknown_string_6'):
                pass
                self._m_unknown_string_6._fetch_instances()

            _ = self.unknown_string_7
            if hasattr(self, '_m_unknown_string_7'):
                pass
                self._m_unknown_string_7._fetch_instances()

            _ = self.unknown_string_8
            if hasattr(self, '_m_unknown_string_8'):
                pass
                self._m_unknown_string_8._fetch_instances()
        ...
        def analyze_date(self):
            ...
            self._m_analyze_date = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def analyze_path(self):
            ...
            self._m_analyze_path = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def autoload_hot_cues(self):
            ...
            self._m_autoload_hot_cues = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def date_added(self):
            ...
            self._m_date_added = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def kuvo_public(self):
            ...
            self._m_kuvo_public = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def release_date(self):
            ...
            self._m_release_date = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def unknown_string_2(self):
            ...
            self._m_unknown_string_2 = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def unknown_string_3(self):
            ...
            self._m_unknown_string_3 = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def unknown_string_4(self):
            ...
            self._m_unknown_string_4 = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def unknown_string_5(self):
            ...
            self._m_unknown_string_5 = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def unknown_string_6(self):
            ...
            self._m_unknown_string_6 = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def unknown_string_7(self):
            ...
            self._m_unknown_string_7 = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
        ...
        def unknown_string_8(self):
            ...
            self._m_unknown_string_8 = RekordboxPdb.DeviceSqlString(self._io, self, self._root)
            self._io.seek(_pos)
